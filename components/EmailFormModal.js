...
export default function EmailFormModal({ visible, email, onEmailChange, onSubmit, onSkip }) {
    ...
    return (
        <Modal visible={visible} transparent animationType="fade">
            <BlurView intensity={120} tint="dark" style={[StyleSheet.absoluteFill, { backgroundColor: 'rgba(30,30,30,0.8)' }]}>
                <KeyboardAvoidingView
                ...
                >
                    <ScrollView contentContainerStyle={[styles.overlay, { width, minHeight: height }]}>
                        ...
                        <Text style={styles.title}>Enter Email to skip the Ad</Text>
                        ...
                        >
                            <TouchableOpacity onPress={onSkip} style={styles.innerskipButton} >
...
const styles = StyleSheet.create({
    ...
    innerskipButton: {
        backgroundColor: 'rgb(30,30,30)', // same as BlurView's fallback background
        borderRadius: 30,
        paddingVertical: 13,
        alignItems: 'center',
        justifyContent: 'center',
    ...
    buttonText: {
        color: '#fff',
        fontWeight: 'bold',
        fontSize: 16, // match image font size
    },
